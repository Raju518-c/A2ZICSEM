...
class Tenant(UUIDModel, TimeStampedModel):
    ...
    service_scope_ids = models.JSONField(default=list, blank=True, help_text="tenant.service_scope_ids cache — see TenantScope for the authoritative rows.")
    ...
    # --- Status & Audit ---
    status_reason = models.TextField(blank=True, help_text="Required when status changes to RESTRICTED/SUSPENDED/ARCHIVED/CLOSED — enforce in serializer/service layer.")
