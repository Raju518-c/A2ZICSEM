...
urlpatterns = [
    ...
    path(
        "tenant-legal-entities/<int:public_id>/",
    ...
    path(
        "tenant-tax-registrations/<int:public_id>/",
    ...
    path("tenant-authorised-representatives/<int:public_id>/", TenantAuthorisedRepresentativeRetrieveUpdateDeleteAPIView.as_view(), name="tenant-authorised-representative-detail"),

    path("tenant-contacts/", TenantContactListCreateAPIView.as_view(), name="tenant-contact-list-create"),
    path("tenant-contacts/<int:public_id>/", TenantContactRetrieveUpdateDeleteAPIView.as_view(), name="tenant-contact-detail"),
    ...
    path("tenant-documents/<int:public_id>/", TenantDocumentRetrieveUpdateDeleteAPIView.as_view(), name="tenant-document-detail"),
    
    
    path("tenant-legal-acceptances/", TenantLegalAcceptanceListCreateAPIView.as_view(), name="tenant-legal-acceptance-list-create"),
    path("tenant-legal-acceptances/<int:public_id>/", TenantLegalAcceptanceRetrieveAPIView.as_view(), name="tenant-legal-acceptance-detail"),

    path("tenant-legal-settings/", TenantLegalSettingsListCreateAPIView.as_view(), name="tenant-legal-settings-list-create"),
    path("tenant-legal-settings/<int:public_id>/", TenantLegalSettingsRetrieveUpdateDeleteAPIView.as_view(), name="tenant-legal-settings-detail"),

    path("tenant-ndas/", TenantNdaListCreateAPIView.as_view(), name="tenant-nda-list-create"),
    path("tenant-ndas/<int:public_id>/", TenantNdaRetrieveUpdateDeleteAPIView.as_view(), name="tenant-nda-detail"),

    path("tenant-settings/", TenantSettingsListCreateAPIView.as_view(), name="tenant-settings-list-create"),
    path("tenant-settings/<int:public_id>/", TenantSettingsRetrieveUpdateDeleteAPIView.as_view(), name="tenant-settings-detail"),
    
    path("tenant-subscriptions/", TenantSubscriptionListCreateAPIView.as_view(), name="tenant-subscription-list-create"),
    path("tenant-subscriptions/<int:public_id>/", TenantSubscriptionRetrieveAPIView.as_view(), name="tenant-subscription-detail"),

    path("modules/", ModuleListCreateAPIView.as_view(), name="module-list-create"),
    path("modules/<int:public_id>/", ModuleRetrieveUpdateDeleteAPIView.as_view(), name="module-detail"),
    ...
    path("tenant-module-entitlements/<int:public_id>/", TenantModuleEntitlementRetrieveUpdateDeleteAPIView.as_view(), name="tenant-module-entitlement-detail"),
    
    
    
    path("tenant-brandings/", TenantBrandingListCreateAPIView.as_view(), name="tenant-branding-list-create"),
    path("tenant-brandings/<int:public_id>/", TenantBrandingRetrieveUpdateDeleteAPIView.as_view(), name="tenant-branding-detail"),

    path("tenant-report-templates/", TenantReportTemplateListCreateAPIView.as_view(), name="tenant-report-template-list-create"),
    path("tenant-report-templates/<int:public_id>/", TenantReportTemplateRetrieveUpdateDeleteAPIView.as_view(), name="tenant-report-template-detail"),
    
    path("tenant-security-settings/", TenantSecuritySettingsListCreateAPIView.as_view(), name="tenant-security-settings-list-create"),
    path("tenant-security-settings/<int:public_id>/", TenantSecuritySettingsRetrieveUpdateDeleteAPIView.as_view(), name="tenant-security-settings-detail"),

    path("tenant-ip-restrictions/", TenantIPRestrictionListCreateAPIView.as_view(), name="tenant-ip-restriction-list-create"),
    path("tenant-ip-restrictions/<int:public_id>/", TenantIPRestrictionRetrieveUpdateDeleteAPIView.as_view(), name="tenant-ip-restriction-detail"),

    path("tenant-integrations/", TenantIntegrationListCreateAPIView.as_view(), name="tenant-integration-list-create"),
    path("tenant-integrations/<int:public_id>/", TenantIntegrationRetrieveUpdateDeleteAPIView.as_view(), name="tenant-integration-detail"),

    path("tenant-billing/", TenantBillingListCreateAPIView.as_view(), name="tenant-billing-list-create"),
    path("tenant-billing/<int:public_id>/", TenantBillingRetrieveUpdateDeleteAPIView.as_view(), name="tenant-billing-detail"),
    
    
    path("tenant-invitations/", TenantInvitationListCreateAPIView.as_view(), name="tenant-invitation-list-create"),
    path("tenant-invitations/<int:public_id>/", TenantInvitationRetrieveUpdateDeleteAPIView.as_view(), name="tenant-invitation-detail"),

    path("tenant-workflows/", TenantWorkflowListCreateAPIView.as_view(), name="tenant-workflow-list-create"),
    path("tenant-workflows/<int:public_id>/", TenantWorkflowRetrieveUpdateDeleteAPIView.as_view(), name="tenant-workflow-detail"),

    path("tenant-workflow-steps/", TenantWorkflowStepListCreateAPIView.as_view(), name="tenant-workflow-step-list-create"),
    path("tenant-workflow-steps/<int:public_id>/", TenantWorkflowStepRetrieveUpdateDeleteAPIView.as_view(), name="tenant-workflow-step-detail"),

    path("tenant-operation-logs/", TenantOperationLogListCreateAPIView.as_view(), name="tenant-operation-log-list-create"),
    path("tenant-operation-logs/<int:public_id>/", TenantOperationLogRetrieveUpdateDeleteAPIView.as_view(), name="tenant-operation-log-detail"),
    
    
    path("tenant-terminology/", TenantTerminologyListCreateAPIView.as_view(), name="tenant-terminology-list-create"),
    path("tenant-terminology/<int:public_id>/", TenantTerminologyRetrieveUpdateDeleteAPIView.as_view(), name="tenant-terminology-detail"),

    path("tenant-numbering-configs/", TenantNumberingConfigListCreateAPIView.as_view(), name="tenant-numbering-config-list-create"),
    path("tenant-numbering-configs/<int:public_id>/", TenantNumberingConfigRetrieveUpdateDeleteAPIView.as_view(), name="tenant-numbering-config-detail"),

    path("tenant-approval-matrices/", TenantApprovalMatrixListCreateAPIView.as_view(), name="tenant-approval-matrix-list-create"),
    path("tenant-approval-matrices/<int:public_id>/", TenantApprovalMatrixRetrieveUpdateDeleteAPIView.as_view(), name="tenant-approval-matrix-detail"),
    ...
    path("tenant-notification-settings/<int:public_id>/", TenantNotificationSettingsRetrieveUpdateDeleteAPIView.as_view(), name="tenant-notification-settings-detail"),

    path("coi-declarations/", ConflictOfInterestDeclarationListCreateAPIView.as_view(), name="coi-declaration-list-create"),
    path("coi-declarations/<int:public_id>/", ConflictOfInterestDeclarationRetrieveUpdateDeleteAPIView.as_view(), name="coi-declaration-detail"),

    path("data-export-requests/", DataExportRequestListCreateAPIView.as_view(), name="data-export-request-list-create"),
    path("data-export-requests/<int:public_id>/", DataExportRequestRetrieveUpdateDeleteAPIView.as_view(), name="data-export-request-detail"),
    
    path("projects/", ProjectListCreateAPIView.as_view(), name="project-list-create"),
    path("projects/<int:public_id>/", ProjectRetrieveUpdateDeleteAPIView.as_view(), name="project-detail"),

    path("project-requirements/", ProjectRequirementListCreateAPIView.as_view(), name="project-requirement-list-create"),
    path("project-requirements/<int:public_id>/", ProjectRequirementRetrieveUpdateDeleteAPIView.as_view(), name="project-requirement-detail"),
    ...
    path("project-requirement-scopes/<int:public_id>/", ProjectRequirementScopeRetrieveUpdateDeleteAPIView.as_view(), name="project-requirement-scope-detail"),

    path("project-candidates/", ProjectCandidateListCreateAPIView.as_view(), name="project-candidate-list-create"),
    path("project-candidates/<int:public_id>/", ProjectCandidateRetrieveUpdateDeleteAPIView.as_view(), name="project-candidate-detail"),

    path("disclosure-requests/", DisclosureRequestListCreateAPIView.as_view(), name="disclosure-request-list-create"),
    path("disclosure-requests/<int:public_id>/", DisclosureRequestRetrieveUpdateDeleteAPIView.as_view(), name="disclosure-request-detail"),

    path("candidate-consents/", CandidateConsentListCreateAPIView.as_view(), name="candidate-consent-list-create"),
    path("candidate-consents/<int:public_id>/", CandidateConsentRetrieveAPIView.as_view(), name="candidate-consent-detail"),

    path("project-placements/", ProjectPlacementListCreateAPIView.as_view(), name="project-placement-list-create"),
    path("project-placements/<int:public_id>/", ProjectPlacementRetrieveUpdateDeleteAPIView.as_view(), name="project-placement-detail"),

    path("project-scope-links/", ProjectScopeLinkListCreateAPIView.as_view(), name="project-scope-link-list-create"),
    path("project-scope-links/<int:public_id>/", ProjectScopeLinkRetrieveUpdateDeleteAPIView.as_view(), name="project-scope-link-detail"),
